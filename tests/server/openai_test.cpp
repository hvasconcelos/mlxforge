// XLLM-022: OpenAI request parsing + response serialization (pure, no GPU).
...
TEST_CASE("XLLM-022: parse_chat_request maps fields and applies defaults") {
...
TEST_CASE("XLLM-022: parse_chat_request rejects malformed/out-of-range requests") {
...
TEST_CASE("XLLM-022: make_chat_completion emits the OpenAI chat.completion shape") {
  json c = make_chat_completion("chatcmpl-1", 1234, "xllm", "Paris.", "stop",
...
TEST_CASE("XLLM-022: parse_completion_request reads a prompt string") {
